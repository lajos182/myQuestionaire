# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2018-07-02 14:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='usepoint',
            name='user',
            field=models.OneToOneField(help_text='用户信息', on_delete=django.db.models.deletion.CASCADE, to='question.User'),
        ),
        migrations.AddField(
            model_name='question',
            name='questionnaire',
        ...
        migrations.AddField(
            model_name='answeritem',
            name='user',
            field=models.ForeignKey(help_text='用户信息', null=True, on_delete=django.db.models.deletion.CASCADE, to='question.User'),
        ),
        migrations.AddField(
            model_name='answer',
            name='questionnaire',
